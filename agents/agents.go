...
To add multiple goals, you can invoke the "GoalProposer" function multiple times as needed.
`)

var GoalProposer = NewAgentool[*GoalResponse]("GoalProposer", "propose goal for the task", models.ModelQwen32B, goalPrompt)
...
GoalSensorOpinion: ...
`)
var GoalSensor = NewAgentool[*interface{}]("GoalProposer", "sensor the goal proposed", models.ModelQwen32B, GoalSensorPrompt)
