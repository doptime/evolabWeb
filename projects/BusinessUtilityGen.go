...
func (u *BusinessUtility) Elo(delta ...int) int {
	var eloDelta int = append(delta, 0)[0]
	return mixincached.WithElo("projects", "BusinessUtility", 1000).Elo(u.Id, float64(eloDelta))
}

var keyBusinessUtility = redisdb.HashKey[string, *BusinessUtility](redisdb.WithRds("projects"))
