...
var AgentIntentionSolveWithMinimalFiles = agents.NewAgent(models.ModelQwQ32B, template.Must(template.New("question").Parse(`
...
func GenQWithMinimalFiles() {
	...
	`)), agents.SaveStringToFile.Tool).WithSaveResponseToLocalFile("IntentionSolved.md").CopyPromptOnly()
