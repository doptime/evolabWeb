...
var AgentProposeAndSave = agents.NewAgent(models.ModelQwQ32B, EvoLabProposeAndSavePrompt, agents.SaveStringToFile.Tool).WithSaveResponseToLocalFile("TaskRequirementProposed.md")
